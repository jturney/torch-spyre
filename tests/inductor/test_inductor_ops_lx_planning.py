...
POINTWISE_TEST_FAILURES = [
    ...
    "test_empty_like_1d_fp16",
    "test_empty_like_2d_fp16",
    "test_empty_like_2d_fp32",
    "test_empty_like_3d_fp16",
    "test_empty_like_memory_format_transposed_2d",
    "test_fill_scalar_1d_compiled",
    "test_full_value_1",
    "test_full_value_2",
    "test_inplace_copy_copy_1d",
    "test_inplace_copy_copy_2d",
    "test_inplace_copy_copy_3d",
    "test_inplace_copy_copy_bool",
    "test_inplace_copy_copy_bool2float",
    ...
    "test_new_ones_size_1",
    "test_pointwise_unary_op_cos_256",
    "test_pointwise_unary_op_cos_67x256",
    "test_pointwise_unary_op_cos_67x71x256",
    "test_pointwise_unary_op_sin_256",
    "test_pointwise_unary_op_sin_67x256",
    "test_pointwise_unary_op_sin_67x71x256",
    "test_rope_fms_fp16",
